...
- (void)viewDidLoad {
    ...
    [UITextField cb_makeTextFieldWithHolder:@"Clip here to start editing ..."
                                  ...
                                  attribute:^(UITextField *f, CBTextFieldDelegate *d) {
                                      ...
                                      [f setValue:[UIColor whiteColor] forKeyPath:@"_placeholderLabel.textColor"];
                                      f.backgroundColor = [UIColor darkGrayColor];
                                      f.layer.cornerRadius = 3.f;
                                      f.textColor = [UIColor whiteColor];
                                  } constraint:^(CBConstraintMaker *make) {
                                      make.top.equalTo(self.cb_topLayoutGuideTop).offset(5.f);
                                      make.left.equalTo(self.view).offset(10.f);
                                      make.right.equalTo(self.view).offset(-10.f);
                                      make.height.cb_equalTo(35.f);
                                  }];
    ...
    [UITableView cb_makeTableViewWithStyle:UITableViewStylePlain
                            cellIdentifier:@"SimpleTableView"
                                 ...
                                 attribute:^(UITableView *t, CBTableViewDelegate *d, CBTableViewDataSourse *s) {
                                     ...
                                     make.top.equalTo(self.cb_topLayoutGuideTop).offset(40.f);
                                     make.left.and.and.right.equalTo(self.view);
                                     make.bottom.equalTo(self.view.CB_centerY);
    ...
    [UILabel cb_makeLabelWithText:@"UIButton"
                        ...
                        attribute:^(UILabel *l) {
                            ...
                            make.top.equalTo(self.view.CB_centerY);
                            make.left.equalTo(self.view).offset(10.f);
                            make.width.cb_equalTo(self.view).multipliedBy(0.5).offset(-15.f);
                            make.height.cb_equalTo(self.view).multipliedBy(0.05);
                        }];
    ...
    [UIButton cb_makeButtonWithTitle:@"点击按钮"
                     ...
                     backgroundColor:[UIColor darkGrayColor]
                           ...
                           attribute:^(UIButton *b) {
                               ...
                               make.top.equalTo(self.view.CB_centerY).offset(20.f);
                               make.left.equalTo(self.view).offset(10.f);
                               make.width.cb_equalTo(self.view).multipliedBy(0.5).offset(-15.f);
                               make.height.cb_equalTo(50.f);
    ...
    [UILabel cb_makeLabelWithText:@"UITextView"
                        ...
                        attribute:^(UILabel *l) {
                            ...
                            make.top.equalTo(self.view.CB_centerY).offset(75.f);
                            make.left.equalTo(self.view).offset(10.f);
                            make.right.equalTo(self.view).offset(-10.f);
                            make.height.cb_equalTo(10.f);
                        }];
    ...
    [UITextView cb_makeTextViewWithDelegate:self
                                  ...
                                  attribute:^(UITextView *x, CBTextViewDelegate *d) {
                                      ...
                                      make.top.equalTo(self.view.CB_centerY).offset(90.f);
                                      make.left.equalTo(self.view).offset(10.f);
                                      make.right.equalTo(self.view).offset(-10.f);
